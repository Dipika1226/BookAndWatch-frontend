...
export default function LocationDropdown() {
  ...
  <Menu as="div" className="relative inline-block text-left z-50 ">
    ...
    <Menu.Items
      className="absolute left-0 mt-7 w-44 max-h-60 overflow-y-auto origin-top-right divide-y divide-gray-900 rounded-md bg-neutral-900/50 shadow-lg ring-1 ring-black/5 focus:outline-none"
    >
      {cities.map((city) => (
        <Menu.Item key={city}>
          {({ active }) => (
